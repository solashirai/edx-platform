...
function (Component) {
    ...
    AbstractMenu = AbstractItem.extend({
        delegateEvents: function () {
            this.getElement()
                .on(this.addNS('keydown mouseleave mouseover'), this.itemHandler.bind(this))
                .on(this.addNS('contextmenu'), function (event) {
    ...
    Menu = AbstractMenu.extend({
        ...
        delegateEvents: function () {
            ...
            this.contextmenuElement.on(this.addNS('contextmenu'), function (event) {
                event.preventDefault();
                event.stopPropagation();
                this.open().position(event).focus();
            }.bind(this));
            $(window).on(this.addNS('resize'), _.debounce(this.close.bind(this), 100));
            return this;
        },
        ...
        undelegateEvents: function () {
            ...
            this.contextmenuElement.off(this.addNS('contextmenu'));
    ...
    MenuItem = AbstractItem.extend({
        ...
        delegateEvents: function () {
            this.getElement().on(
                this.addNS('click keydown contextmenu mouseover'),
